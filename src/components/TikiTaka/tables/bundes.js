...
export default function Bundes(props) {
  const [teams, setTeams] = useState([]);
  const [isLoading, setIsLoading] = useState(true);
  const bundes = (<>
    <br></br>
      <br></br>
      <h1 className="letra">BUNDESLIGA 2022</h1>
      <br></br>
      <div className="table-container">
        <div className="bundes">
          <h1>Posição</h1>
          <h1></h1>
          <h1></h1>
          <h1></h1>
  ...
  useEffect(() => {
    axios
      .get("https://sleepy-wave-09569.herokuapp.com/bundes")
  ...
  return (
    <main className="App">
      <Appbar/>
      {isLoading ? <LoadingSpinner/> : bundes}
      <Bottom/>
    </main>
  );
}